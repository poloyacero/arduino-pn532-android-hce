...
public final class IndicatorViewController {
    ...
    private void updateCaptionViewsVisibility(final int captionToHide, final int captionToShow2, boolean animate) {
        if (animate) {
            ...
            captionAnimator2.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    IndicatorViewController.this.captionDisplayed = captionToShow2;
