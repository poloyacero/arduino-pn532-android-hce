                    ...
                    while (true) {
                        ...
                        if (isValidPointerForActionMove(pointerId2)) {
                            ...
                            if (pastSlop) {
                                ...
                                action = action2;
                                int newLeft = this.mCallback.clampViewPositionHorizontal(toCapture2, ((int) dx) + oldLeft, (int) dx);
                                int oldTop = toCapture2.getTop();
                                actionIndex = actionIndex2;
                                pointerCount = pointerCount2;
                                int newTop = this.mCallback.clampViewPositionVertical(toCapture2, ((int) dy) + oldTop, (int) dy);
