...
public class ConstraintLayout extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r8v3 'layoutParams'  androidx.constraintlayout.widget.ConstraintLayout$LayoutParams: [D('layoutParams' androidx.constraintlayout.widget.ConstraintLayout$LayoutParams), D('child' android.view.View)] */
            ...
            if (widget2 == null) {
                ...
                if (layoutParams2.isGuideline) {
                    ...
                    if (Build.VERSION.SDK_INT < 17) {
                        ...
                        if (resolvedLeftToLeft8 == -1 && resolvedLeftToRight3 == -1) {
                            resolvedLeftToLeft6 = resolvedLeftToLeft8;
                    ...
                    if (width3 == 0 || height3 == 0) {
                        ...
                        if (width3 != 0 || height3 != 0 || !bothHorizontal || !bothVertical) {
                            ...
                            if (height3 != 0) {
                                ...
                                int childHeightMeasureSpec2 = getChildMeasureSpec(parentHeightSpec, heightPadding2, -2);
                                didWrapMeasureHeight2 = USE_CONSTRAINTS_HELPER;
                                resolveHeight = false;
                                childHeightMeasureSpec = childHeightMeasureSpec2;
                            } else {
