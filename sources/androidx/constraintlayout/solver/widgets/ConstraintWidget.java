            ...
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && matchConstraintDefaultWidth2 == 3 && matchConstraintDefaultHeight2 == 3) {
                ...
                if (useRatio) {
                    ...
                    if (this.mHorizontalResolution == 2) {
                        ...
                        SolverVariable parentMax = constraintWidget3 != null ? system.createObjectVariable(constraintWidget3.mRight) : null;
                    ...
                    if (this.mVerticalResolution == 2) {
                        ...
                        boolean useVerticalRatio = useRatio && ((i = this.mResolvedDimensionRatioSide) == 1 || i == -1);
                        if (this.mBaselineDistance <= 0) {
                            linearSystem = system;
                            top2 = top;
                        ...
                        applyConstraints(system, verticalParentWrapContent2, constraintWidget62 == null ? linearSystem.createObjectVariable(constraintWidget62.mTop) : null, parentMax2, this.mListDimensionBehaviors[1], wrapContent2, this.mTop, this.mBottom, this.mY, height, this.mMinHeight, this.mMaxDimension[1], this.mVerticalBiasPercent, useVerticalRatio, inVerticalChain, matchConstraintDefaultHeight, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, applyPosition2);
                        if (useRatio) {
                        }
                        if (!this.mCenter.isConnected()) {
                        }
        ...
        if (!variableSize2) {
            ...
            if (matchConstraintDefault2 == 1) {
                ...
                if (beginAnchor.getType() == ConstraintAnchor.Type.TOP || beginAnchor.getType() == ConstraintAnchor.Type.BOTTOM) {
                    percentEnd = system.createObjectVariable(this.mParent.getAnchor(ConstraintAnchor.Type.TOP));
                    percentEnd2 = system.createObjectVariable(this.mParent.getAnchor(ConstraintAnchor.Type.BOTTOM));
                } else {
                    percentEnd = system.createObjectVariable(this.mParent.getAnchor(ConstraintAnchor.Type.LEFT));
