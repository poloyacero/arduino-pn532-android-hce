...
public class Toolbar extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout || shouldLayout2) {
            ...
            if (z2) {
                ...
                if (shouldLayout2) {
                    ...
                    int i23 = i13 + layoutParams5.topMargin;
                    this.mSubtitleTextView.layout(min2 - this.mSubtitleTextView.getMeasuredWidth(), i23, min2, this.mSubtitleTextView.getMeasuredHeight() + i23);
                ...
                if (shouldLayout2) {
                    ...
                    int i26 = i13 + layoutParams6.topMargin;
        ...
        for (int i28 = 0; i28 < size; i28++) {
            max = layoutChildLeft(this.mTempViews.get(i28), max, iArr, i10);
        }
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i29 = 0; i29 < size2; i29++) {
            min2 = layoutChildRight(this.mTempViews.get(i29), min2, iArr, i10);
        }
